...
1. _True Positives_ - If OUT != `""` and GT != `""` and OUT == GT
2. _False Positives_ - If OUT != `""` and GT != `""` and OUT != GT
3. _False Positives_ - If OUT != `""` and GT == `""`
4. _False Negatives_ - If OUT == `""` and GT != `""`
5. _True Negatives_ - If OUT == `""` and GT == `""`
